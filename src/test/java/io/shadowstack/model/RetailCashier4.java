...
public class RetailCashier4 {
    ...
    @Convert(to = Confirmation.class, use = Receipt2Confirmation3.class, singletonInstance = "FOO")
    public Receipt checkout(@Convert(to = VirtualCart.class, use = VirtualCart2PhysicalCart3.class, factoryMethod = "getSingleton") PhysicalCart cart) {
        double total = 0.0D;
        if(cart != null) {
